...
- **Landing Rebuild** (`.claude/skills/landing-rebuild/`) — Clone any landing page into a self-hosted Next.js 16 + Tailwind v4 + TypeScript codebase. Produces two side-by-side rebuilds: a faithful 1:1 clone for production + a bold creative variant for design exploration, plus extraction artifacts (markdown copy, design tokens, screenshots, downloaded assets). Say "rebuild [URL]", "clone [URL]", "convert this Framer site to Next.js", "self-host this site", "give me the code for this site"
