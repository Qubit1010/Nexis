...
**Source basis:** `research-synthesis.md` Q1/Q3/Q4/Q7 (237-source NotebookLM synthesis). `[sN]` -> `_research/sources.json`. Use this to avoid steering Aleem (or a client) wrong. **Honesty rule:** if you're unsure a limit still holds, check the live notebook.
