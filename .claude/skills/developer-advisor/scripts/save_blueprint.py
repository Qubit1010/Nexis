#!/usr/bin/env python3
"""Save a developer build blueprint as a formatted Google Doc via gws CLI.

Reads blueprint JSON from stdin, creates a Google Doc with proper formatting
(headings, body text, bullets, tables), and saves it to the NexusPoint Dev Blueprints
folder in Google Drive.

Usage:
    echo '{"title":"...","sections":[...]}' | python save_blueprint.py
    cat blueprint.json | python save_blueprint.py
...
DRIVE_FOLDER_NAME = "NexusPoint Dev Blueprints"
