...
Read the maintained skill at `E:\Projects\Reel Generator\.agents\skills\nexis-reel-studio\SKILL.md` and execute its workflow.
Runtime workspace: `E:\Projects\Reel Generator`. Resolve supporting references against the canonical skill folder.
