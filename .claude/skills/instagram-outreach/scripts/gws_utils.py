"""Shared Google Sheets utilities for the Instagram Outreach skill."""
...
SHEET_NAME = "NexusPoint Instagram Outreach CRM"
TAB_LEADS = "Leads"
...
def run_gws(args, json_body=None):
    ...
    if result.returncode != 0:
        ...
        raise RuntimeError(f"gws error: {stderr or stdout}")
...
def get_or_create_sheet():
    """Find or create the Instagram Outreach CRM sheet. Returns sheet_id."""
