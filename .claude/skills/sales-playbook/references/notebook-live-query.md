...
2. After checking the relevant framework/script file + scanning `references/research-synthesis.md` (Q1 Openers, Q2 LinkedIn, Q3 Instagram, Q4 Closing, Q5 Objections), you **don't have a confident, specific answer**.
