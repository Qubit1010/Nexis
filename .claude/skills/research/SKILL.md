---
name: research
description: "The single research + web-search front door. Combines four search services (Exa neural, Tavily, Serper/Google, Jina) at three depths - light (fast answer), medium (2-3 engines fused + ranked), deep (all engines + content extraction + a cited, saved report) - and cross-checks them so you get the best fused result, or deep single-service research on demand. Handles four task shapes: general-topic research, finding a specific person/company/founder (entity mode, Google-dork + LinkedIn X-ray + email discovery), scientific/academic research, and PRACTICAL mode for how-to / examples / teardowns / social-and-platform questions, which excludes journal hosts from Exa and pulls in blogs and YouTube instead of research papers. Scientific still wins when a question genuinely asks for evidence, so 'meta-analysis of Instagram engagement' stays a research question while 'how do I format an Instagram caption' does not. FIRST routes free-tool / API / software / service lookups to the scout skills (api-scout, free-tool-scout, free-for-dev-scout, selfhosted-scout) and only researches live if their catalogs miss. Use whenever Aleem says 'research X', 'deep/medium/light research', 'search X across sources', 'find info on X', 'look up X', 'who is X', 'find the founder/CEO of X', 'find [company]'s [people/email/tech stack]', 'cross-check this across Exa and Tavily', 'combine the search engines', 'research this scientifically / find papers on X', or asks to find a free tool/API (it checks the scouts first). Supersedes the old deep-research skill. Hands off free-tool catalogs to the scout skills, university coursework to assignment-research, content research to post-creator, and sales strategy to sales-playbook."
