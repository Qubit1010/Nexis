...
Style: full-bleed cinematic photo, deep navy/blue color grade (agency brand blue wash #A6DAFF to #00B7FF over near-black #0A1420 shadows), heavy film grain. Subject: <describe a person, crowd, environment, or object that matches the post topic>.
...
Style: full-bleed cinematic photo — different scene from the cover (crowd overhead, dark texture, abstract environment). Same deep navy/blue color grade (agency brand blue #A6DAFF to #00B7FF) and heavy film grain.
Handle (small, white, centered near top): "@<HANDLE>"
