...
# Pointer to `.claude/skills/marketing-skills/social/`

This file is a pointer, not a copy. Read and follow the canonical skill at
`.claude/skills/marketing-skills/social/SKILL.md` (path from the repository root), and resolve every file it
